...
b=Ah("//googleads.g.doubleclick.net/pagead/id",a)}),function(c){c instanceof Kf&&b.abort();
return Gf(c)})}
...
function Ln(){var a=window.location.protocol,b=W.getEntriesByType("resource");b=bb(b,function(c){return 0===c.name.indexOf(a+"//fonts.gstatic.com/s/")});
...
try{Yn("//static.doubleclick.net/instream/ad_status.js",a)}catch(b){}fo.push(Yg.L(function(){if(!(go||"google_ad_status"in window)){try{eo("//static.doubleclick.net/instream/ad_status.js",a)}catch(b){}go=!0;L("DCLKSTAT",3)}},5E3))}}
...
F("PL_ATT")&&no.dispose();for(var a=0,b=fo.length;a<b;a++)Yg.aa(fo[a]);fo.length=0;co("//static.doubleclick.net/instream/ad_status.js");go=!1;L("DCLKSTAT",0);(0,Wd)(rp,qp);pp&&(pp.removeEventListener("onVideoDataChange",sp),pp.destroy())});
